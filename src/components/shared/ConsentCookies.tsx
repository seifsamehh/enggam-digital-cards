...
const ConsentCookies = () => {
  ...
  return (
    !consentAccepted && (
      <div className="cookie-banner flex justify-between items-center px-2 fixed bottom-0 left-0 right-0 bg-destructive text-destructive-foreground z-50 h-24 w-screen">
