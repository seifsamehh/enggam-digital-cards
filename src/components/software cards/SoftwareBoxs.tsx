...
const SoftwareBoxs = () => {
  const softwareCards = subCategories.find(
    (category) => category.name === "Software Cards"
  );
  const mappedSubCategories = softwareCards?.sub?.map((subcategory) => {
    return {
